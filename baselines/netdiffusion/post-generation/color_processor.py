...
org_dir = '../../../result/netdiffusion/generated_imgs/'

counter = 0
for i in os.listdir(org_dir):
    if 'png' in i:
        input_file = '../../../result/netdiffusion/generated_imgs/' + i
        output_file = '../../../result/netdiffusion/color_processed_generated_imgs/' + i
