...
org_data_dir = '../../../result/netdiffusion/generated_nprint'
out_put_data_dir = '../../../result/netdiffusion/replayable_generated_pcaps'
out_put_nprint_dir = '../../../result/netdiffusion/replayable_generated_nprints'

files = [f for f in os.listdir(org_data_dir) if f.endswith('.nprint')]

for org_nprint in tqdm(files, desc="Processing nprint files"):
