                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=816, elem_id="txt2img_width")
                        ...
                        with gr.Row(elem_id="txt2img_accordions", elem_classes="accordions"):
                            with InputAccordion(False, label="Hires. fix", elem_id="txt2img_hr") as enable_hr:
                                with enable_hr.extra():
                                    hr_final_resolution = FormHTML(value="", elem_id="txtimg_hr_finalres", label="Upscaled resolution", interactive=True, min_width=0)
                                ...
                                with FormRow(elem_id="txt2img_hires_fix_row2", variant="compact"):
                                    hr_scale = gr.Slider(minimum=1.0, maximum=4.0, step=0.05, label="Upscale by", value=1.0, elem_id="txt2img_hr_scale", interactive=True)
                                    hr_resize_x = gr.Slider(minimum=0, maximum=2048, step=8, label="Resize width to", value=1088, elem_id="txt2img_hr_resize_x", interactive=True)
                                    hr_resize_y = gr.Slider(minimum=0, maximum=2048, step=8, label="Resize height to", value=1024, elem_id="txt2img_hr_resize_y", interactive=True)
                            ...
                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                ...
                                with gr.Tabs():
                                    with gr.Tab(label="Resize to", elem_id="img2img_tab_resize_to") as tab_scale_to:
                                        with FormRow():
                                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                                width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=816, elem_id="img2img_width")
                                                height = gr.Slider(minimum=64, maximum=2048, step=8, label="Height", value=768, elem_id="img2img_height")
        ...
        with gr.Row(variant="compact", equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train", id="train"):
                    ...
                    training_width = gr.Slider(minimum=64, maximum=2048, step=8, label="Width", value=816, elem_id="train_training_width")
                    training_height = gr.Slider(minimum=64, maximum=2048, step=8, label="Height", value=768, elem_id="train_training_height")
